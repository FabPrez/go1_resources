...
setup(
    ...
    data_files=[
        ...
        ('share/' + package_name + '/map_multi_room',
            glob('map_multi_room/*')),
        ('share/' + package_name + '/models/rubattino3d',
            ['models/rubattino3d/model.config', 'models/rubattino3d/model.sdf']),
        ('share/' + package_name + '/models/rubattino3d/meshes',
            ['models/rubattino3d/meshes/rubattino3d_go1.stl']),
    ],
